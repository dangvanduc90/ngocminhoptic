...
<div class="card mb-3">
  <div class="card-body">
    <div class="row">
      <div class="col-lg-8">
        <h3 class="mb-0">Thêm mới: Cấu hình mẫu giấy/email</h3>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        <div class="row">
            <div class="col-8">
                <form id="form" class="form-horizontal" role="form" action="{{route('template.store')}}" 
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{isset($template) ? $template->ngaybatdau : old('ngaybatdau')}}" class="form-control datetimepicker" name="ngaybatdau" id="ngaybatdau" type="text" data-options='{"dateFormat":"d/m/Y","enableTime":false}'>
                    </div>
                    <div class="form-group">
