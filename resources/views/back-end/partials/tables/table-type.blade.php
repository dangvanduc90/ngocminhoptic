<table class="table table-striped table-bordered table-hover dataTables-example">
	<thead>
		<tr>
			...
			<th class="text-center">Tiêu đề tiếng việt</th>
			<th class="text-center">Tiêu đề tiếng anh</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{ $obj->name_en }}</td>
			...
			<td class="text-center">
				<a href="{{route('type.edit', ['id'=>$obj->id])}}" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
				<a 	class="btn btn-danger btn-circle btn-sm delete-button" 
					data-action ="{{ route('type.destroy',$obj->id) }}" type="button">
